...
import eu.chorevolution.vsb.gm.protocols.observers.BcGmSubComponentObserver;
import eu.chorevolution.vsb.gm.protocols.observers.BcSubComponentObserver;
...
public abstract class BcGmSubcomponent implements Manageable{
  ...
  protected BcSubComponentObserver subComponentObserver;
  ...
  public void registerObserver(String name) {
	  this.subComponentObserver = new BcSubComponentObserver(name);
  }
