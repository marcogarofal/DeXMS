...
public class MediatorDPWSGenerator extends MediatorSubcomponentGenerator {
	...
	public MediatorDPWSGenerator(GmServiceRepresentation componentDescription, MediatorConfiguration bcConfiguration) {
	...
	private void buildServiceClass(JCodeModel codeModel, Collection<Operation> operations) {
		...
		JClass BcDPWSSubcomponentClass = codeModel.ref(MediatorDPWSSubcomponent.class);
