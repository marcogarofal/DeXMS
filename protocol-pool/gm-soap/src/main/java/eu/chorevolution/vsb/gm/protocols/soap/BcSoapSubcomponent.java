...
public class BcSoapSubcomponent extends BcGmSubcomponent {
	...
	public BcSoapSubcomponent(BcConfiguration bcConfiguration, GmServiceRepresentation serviceRepresentation) {
		...
		case SERVER:
			...
			try {
				...
				this.endpoint = Endpoint.publish(endpointAddress,
						bc.getDeclaredConstructor(BcGmSubcomponent.class).newInstance(this));
