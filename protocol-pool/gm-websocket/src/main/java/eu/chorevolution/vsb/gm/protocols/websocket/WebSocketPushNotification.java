...
public class WebSocketPushNotification extends Thread {
	...
	public WebSocketPushNotification(WebSocketServer webSocketServer, BcWebsocketSubcomponent bcWebsocketSubcomponent,
	...
	public void webSocketPushNotification(WebSocketServer webSocketServer,
			BcWebsocketSubcomponent bcWebsocketSubcomponent, SynchronousQueue<byte[]> buffer) {
